...
const MAP_BG  = require('../../../assets/castle_bg.png');
const ISLE_BG = require('../../../assets/castle_bg.png');
  ...
  return (
    <Animated.View style={{ transform: [{ translateY: y }], marginBottom: 14 }}>
      ...
      >
        ...
        <Image source={ISLE_BG} style={StyleSheet.absoluteFillObject} contentFit="cover" />
...
export default function WorldMapScreen() {
  ...
  return (
    <View style={styles.root}>
      ...
      <Image source={MAP_BG} style={StyleSheet.absoluteFillObject} contentFit="cover" />
