...
**Endpoint:** `GET https://app-cumnzg2pfz0h-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-cumnzg2pfz0h-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
